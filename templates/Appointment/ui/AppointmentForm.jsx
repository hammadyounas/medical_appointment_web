...
export default function AppointmentForm({prevStep, formData, handleSubmit}) {
  return (
    ...
    <input className="w-full p-2 border rounded mb-2" placeholder="Name" required />
    <input className="w-full p-2 border rounded mb-2" type="email" placeholder="Email" required />
    <input className="w-full p-2 border rounded mb-2" type="tel" placeholder="Phone Number" required />
