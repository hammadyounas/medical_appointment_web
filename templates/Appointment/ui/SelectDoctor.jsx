...
export default function SelectDoctor({ doctorsOptions,
    handleDoctorChange,
    selectedDoctor,nextStep, prevStep }) {  
  ...
  return (
    ...
    <div className="flex justify-between w-full mt-4">
      <Button className="bg-gray text-white px-4 py-2 rounded" onClick={prevStep} text={'Back'}/>
